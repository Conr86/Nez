...
namespace Nez
{
	public class Core : Game
	{
		...
		public Core(int width = 1280, int height = 720, bool isFullScreen = false, string windowTitle = "Nez", string contentDirectory = "Content", bool preferHalfPixelOffset = true)
		{
#if DEBUG
			...
			var graphicsManager = new GraphicsDeviceManager(this)
			{
				...
				PreferHalfPixelOffset = preferHalfPixelOffset,
